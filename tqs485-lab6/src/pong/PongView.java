...
public class PongView extends JFrame {
    ...
    public PongView(PongModel model) {
        ...
        /*
         * CENTER: The panel where Pong is played
         */
        ...
        /*
         * SOUTH: A status bar for telling us what happens. Borrowed from Figure
         * 14.15.
         */
     ...
     * 
     * @param controller1
     *            a PongMouseController
     * @param controller2
     *            a PongResizeController
     * @param controller3
     *            a PongMenuController
     * @param controller4
     *            a PongPopupController
     */
    public void registerListeners(PongMouseController controller1,
            PongResizeController controller2, PongMenuController controller3,
     ...
     * 
     * @param y
     *            vertical location of mouse or model
     */
